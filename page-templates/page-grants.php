...
$grants = [
    ...
    [
        ...
        'type'   => '内閣府第3期戦略的イノベーション創造プログラム（SIP）',
        'title'  => 'デジタルツインを用いた個別最適な学び方・働き方の実現',
        'pi'     => '緒方広明',
        'summary'=> '「ポストコロナ時代の学び方・働き方を実現するプラットフォームの構築」（課題番号: 23814782）'
    ],
    ...
    [
        'year'   => '2016',
        'period' => '2016年5月31日〜2022年3月31日', // KAKEN準拠（LEAFの〜2022は誤りのため修正）
        'type'   => '科学研究費（補助金）',
        'title'  => '基盤研究（S）',
        'pi'     => '緒方広明',
