  ...
  <div class="container leaf-intro__container">
    <div class="leaf-intro__content">
      ...
      <div class="leaf-intro__links">
        <a href="https://eds.let.media.kyoto-u.ac.jp/leaf/" target="_blank" class="btn btn--accent btn--overlay"><span>LEAF公式サイトを見る</span></a>
        <a href="https://live.let.media.kyoto-u.ac.jp/evidence-portal/" target="_blank" class="btn btn--accent btn--overlay"><span>エビデンスポータルを見る</span></a>
      </div>
    </div>
  </div>
</section>
