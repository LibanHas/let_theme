...
<div class="row align-items-center voice-block mb-5">
  ...
  <!-- Quote scrolls DOWN -->
  <div class="col-md-6 scroll-float ps-md-3" data-speed="0.05">
  <div class="container px-0">
    <div class="founder-quote-box">
      <span class="quote-icon">“</span>
      <p class="founder-quote-text">
      緒方研究室では、研究だけでなく『人との関わり方』も大切な学びの一つだと実感しています。
      </p>
    </div>
  </div>
</div>
...
<div class="voice-qa-wrapper">
  <div class="qa-block">
    ...
    <div class="qa-item">
      ...
      <p>
        研究室では、ゼミ等の発表やディスカッションを通じて、自分の研究を深めたり他の人の視点を取り入れたりする機会が多くあります。
        先生方や先輩方にも気軽に質問や相談ができる環境で、研究室が一体となって、熱意を持って研究に取り組んでいると感じます。
      </p>
    </div>
    ...
    <div class="qa-item">
      ...
      <p>
        はじめは、学生を専業として進学した日本人学生が少数派であることにとても驚きました。
        さまざまなバックグラウンドを持つ方と話す中で、「授業での参加の仕方」や「学びへの姿勢」に国や文化の違いがあることに気づき、
        非常に刺激を受けています。英語・日本語の両方でのコミュニケーションが求められる環境の中で、
        英語は「学ぶべきもの」から「使うための道具」へと意識が変わりました。
      </p>
    </div>
    ...
    <div class="qa-item">
      ...
      <p>
        緒方研究室では、研究だけでなく「人との関わり方」も大切な学びの一つだと実感しています。
        実際の教育現場で日常的に使われるシステムを研究・開発・実証を行うので、さまざまな立場の方と関わる機会があります。
        開発者、現場の先生方、生徒、それぞれのニーズや制約を理解し、調整しながら研究を進めることが求められます。
        こうした経験を通して、単なる技術開発にとどまらず、実社会に根ざした研究のあり方を学んでいます。
      </p>
    </div>
...
<div class="voice-qa-wrapper">
  <div class="qa-block">
    ...
    <div class="qa-item">
      ...
      <p>
      ニュージーランドで教育工学を学んでいたときに、学習ログを活用した研究に興味を持ちました。その中で、BookRollやLogPaletteなどのツールを活用して教育現場で実証的な研究を行っている緒方研究室を知り、「ここでなら自分の研究を深められる」と思って志望しました。
      </p>
    </div>
    ...
    <div class="qa-item">
      ...
      <p>
      先生方からの丁寧な指導に加えて、週ごとのゼミでフィードバックをもらえる環境がとてもありがたいです。また、同じように留学生として頑張っている仲間がいるので、精神的にも支えられています。英語・日本語の両方で情報が得られるのも大きな助けになっています。
      </p>
    </div>
    ...
    <div class="qa-item">
      ...
      <p>
      国際的な環境で、自分のペースで研究を進めたい人にはとてもおすすめの研究室です。教育現場とつながりながら実践的な研究ができるので、理論と現場を結びつけたい人には特に合っていると思います。日本語が完璧でなくても、安心して参加できる雰囲気がありますよ。
      </p>
    </div>
  </div>
</div>
